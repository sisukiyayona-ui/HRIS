          ...
          <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                  <div style="position:relative; width:100%; height:0px; padding-bottom:85%;">
                      <iframe id="monitor" style="position:absolute; left:0; top:0; width:100%; height:100%" src="<?php echo base_url() ?>Kantin/monitor_baros">
                      </iframe>
                  </div>
              </div>
          </div>
  ...
  <script type="text/javascript">
          ...
          $.ajax({
              ...
              success: function(data, response) { // Ketika proses pengiriman berhasil
                  ...
                  if (data[0] == "Hadir") {
                      ...
                      $.ajax({
                          type: "POST", // Method pengiriman data bisa dengan GET atau POST
                          url: "<?php echo base_url(); ?>Kantin/save_makan_baros", // Isi dengan url/path file php yang dituju
                          async: false,
                          data: {
                              nik: nik,
                          }, // data yang akan dikirim ke file yang dituju
      ...
      function getData() {
          ...
          var table = $('#t_pantry').DataTable({
              ...
              "ajax": {
                  type: "POST",
                  url: "<?php echo base_url(); ?>Kantin/makan_today_baros",
                  dataType: 'JSON',
