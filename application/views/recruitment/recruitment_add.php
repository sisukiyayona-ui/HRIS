          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="<?php echo base_url()?>index.php/Recruitment/recruitment_view"><i class="fa fa-arrow-circle-o-left"></i></a> | FPTK Disetujui</h2>
                      ...
                      <tbody>
                       ...
                       foreach ($fptk as $data) {
                        ...
                        if($role == '1' or $role == '2' or $role == '5' or $role == '25'){?>
                          <a href="<?php echo base_url()?>index.php/Recruitment/recruitment_insert/<?php echo $data->recid_kfptk?>" data-toggle="tooltip" data-placement="top" title="Create"><button class="btn btn-primary  btn-xs"><span class='fa fa-bullhorn'></span></button></a>
                        <?php } ?>
                      <?php } ?>
