                     ...
                     <form id="form_realisasi" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Karyawan/realisasi_pinsert" novalidate >
                      ...
                      if($role == '5')
                        { ?>
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <input type="hidden" name="recid_mbl" id="mbl" class="form-control col-md-7 col-xs-12" placeholder="mbl" value="<?php echo $data->recid_mbl ?>">
                            </div>
                          </div>
                        <?php }
                        ?>
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="total_jam" required="required" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" value="<?php echo $data->jml_orang ?>" readonly = 'readonly' >
                        </div>
                      </div>
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="judul">Realisasi Orang <span class="required" style="color: red">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="realisasi_orang" id="realisasi_orang" required="required" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" placeholder="Realisasi Orang" >
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="pekerjaan" class="form-control" value="<?php echo $data->pekerjaan ?>"><?php echo $data->pekerjaan; ?></textarea>
                        </div>
                      </div>
                       <div class="item form-group">
