              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Karyawan/realisasi_pupdate" novalidate >
                      <?php foreach ($realisasi as $data) {
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="hidden" name="recid_lembur" id="recid_lembur" value="<?php echo $data->recid_lembur ?>">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="recid_bag" id="bag"  class="selectpicker form-control  col-md-12 col-xs-12" data-live-search="true" required="required" disabled="disabled">
                            <?php
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="judul">Pengajuan Jumlah Orang <span class="required" style="color: red">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="jml_orang" required="required" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" value="<?php echo $data->jml_orang ?>" readonly = 'readonly' >
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="judul">Realisasi Jumlah Orang <span class="required" style="color: red">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         
                          <input type="text" name="realisasi_orang" id="total_lembur" required="required" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" value="<?php echo $data->realisasi_orang ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" name="realisasi_jam" id="total_lembur" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" value="<?php echo $data->realisasi_jam ?>" readonly = 'readonly'>
                          <?php }else{ ?>
                          <input type="text" name="realisasi_jam" id="total_lembur" required="required" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" value="<?php echo $data->realisasi_jam ?>">
                          <?php } ?>
                           <!-- <input type="text" name="realisasi_jam2" id="total_lembur2" required="required" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" value="<?php echo $data->realisasi_jam ?>"> -->
                          <input type="hidden" name="recid_mbl" id="mbl" class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="judul">Pekerjaan 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="pekerjaan" class="form-control"><?php echo $data->pekerjaan ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="item form-group" id="alasan">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="keterangan" class="form-control" placeholder="qty lembur"><?php echo $data->notes ?></textarea>
                        </div>
                      </div>
                          ...
                          $i = 0;
                            foreach ($detail as $det) { ?>
                              <tr>
                                ...
                                <td><?php echo $det->pekerjaan ?></td>
                                <td><?php echo $det->target_kerja ?></td>
                                <?php
                                  if($role == '5')
                                  { ?>
                                    <td><input type="text" size="4" name="hasil[]" class="form-control" onkeypress="return hanyaAngka(event)" required="required" value="<?php echo $det->hasil ?>" readonly="readonly"></td>
                                  <?php }else{ ?>
                                    <td><input type="text" size="4" name="hasil[]" class="form-control" onkeypress="return hanyaAngka(event)" required="required" value="<?php echo $det->hasil ?>"></td>
                                  <?php }
                                ?>
                                <td><input type="hidden" name="recid_detlembur[]" class="form-control"required="required" value="<?php echo $det->recid_detlembur ?>"></td>
                              </tr>
                            <?php }
                           ?>
                        </tbody>
...
$("#total_lembur").change(function(){
 ...
 /*var realisasi_jam2 = document.getElementById("total_lembur2").value;
 if(realisasi_jam2 == 'NaN')
 {
  //realisasi_jam2 = '0';
  document.getElementById("total_lembur2").value = '0';
 var realisasi_jam2 = document.getElementById("total_lembur2").value;
}else{
 realisasi_jam2 = parseInt(realisasi_jam2);
 realisasi_jam2 = realisasi_jam2;
}
console.log(realisasi_jam2);*/
            ...
            $.ajax({  //---------------------------------------- get recid mbl --------------------------------------------------------
              ...
              jml_jam = response[0];
                  ...
                  success: function(response, data){ // Ketika proses pengiriman berhasil
                    ...
                    // kurang = total + realisasi_jam - realisasi_jam2;
