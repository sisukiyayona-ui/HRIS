                  ...
                  <div class="x_content">
                     <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Karyawan/plembur_pinsert" data-toggle="validator">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="jml_orang" id="jml_orang" required="required" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" placeholder="Jumlah Orang">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="keterangan" class="form-control" placeholder="Keterangan lembur"></textarea>
                        </div>
                      </div>
                      
                      <div id="repeater">
                        <div class="repeater-heading" align="center">
                          <button type="button" class="btn btn-primary repeater-add-btn">Tambah Pekerjaan</button>
                        </div>
                        <div class="clearfix"></div>
                            ...
                            <div class="form-group">
                              <div class="row">
                               <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <textarea name="pekerjaan[]" id="pekerjaan[]" class="form-control" placeholder="kegiatan lembur"></textarea>
                                </div>
                              </div>
                               <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                <!--  <input type="text" name="dinamis[]" id="dinamis[]" required="required" onkeypress="return hanyaAngka(event)" class="form-control col-md-7 col-xs-12" placeholder="Target"> -->
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                         ...
                         <button id="send" type="submit" class="btn btn-success" onclick="cek_pekerjaan()">Submit</button>
                       </div>
                     </div>
                     </form>
                  </div>
