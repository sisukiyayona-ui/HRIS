          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="<?php echo base_url()?>Karyawan/r_pengajuan"><i class="fa fa-arrow-circle-o-left"></i></a> | Report Pengajuan Lembur Periode <?php echo $newDate = date("d M Y", strtotime($tgl_awal)); ?> s/d <?php echo $newDate = date("d M Y", strtotime($tgl_akhir)); ?> </h2>
                    </a> 
