      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <tbody>
             <?php  
             $pay_group = $this->db->query("SELECT DISTINCT pay_group from bagian b join master_budget mb on b.recid_bag = mb.recid_bag where mb.tahun =  '$tahun' and $role")->result();
                   ...
                   <?php 
                      for($x=0; $x<15;$x++){
                        ...
                        <?php }else{
                         ...
                         $total_realisasi = $this->db->query("SELECT sum(realisasi_jam) as total_realisasi from realisasi_lembur rl join pengajuan_lembur pl on pl.recid_plembur = rl.recid_plembur join master_budget mb on pl.recid_mbl = mb.recid_mbl join bagian b on mb.recid_bag = b.recid_bag where tahun = '$tahun' and pay_group = '$pay->pay_group' and bulan = '$month[$x]' and ($role)")->result();
                         foreach ($total_budget as $total_budget) { }
                           if($total_budget->total_budget == null){
                            $total_budget = '0';
                          }else{
                ...
                <?php 
                      for($x=0; $x<15;$x++){
                        ...
                        if((($x+4) == 3 || ($x+4) == 7 || ($x+4) == 11 || ($x+4) == 15 || ($x+4) == 19  ) and $x != 0){ 
                          ...
                          $grandr = $this->db->query("SELECT sum(realisasi_jam) as grandr  from realisasi_lembur rl join pengajuan_lembur pl on pl.recid_plembur = rl.recid_plembur join master_budget mb on mb.recid_mbl = pl.recid_mbl join bagian b on mb.recid_bag = b.recid_bag where kuartal = '$moon' and ($role) and tahun = '$tahun'")->result();
                        ...
                        <?php }else{
                          ...
                          $grandr = $this->db->query("SELECT sum(realisasi_jam) as grandr  from realisasi_lembur rl join pengajuan_lembur pl on pl.recid_plembur = rl.recid_plembur join master_budget mb on mb.recid_mbl = pl.recid_mbl join bagian b on mb.recid_bag = b.recid_bag where bulan = '$month[$x]' and ($role) and tahun = '$tahun'")->result();
                          foreach ($grandb as $grandb) { }
                            if($grandb->grandb == '0' || $grandb->grandb == null){
                              $grandb = '0';
                            }else{
                      ...
                      foreach ($grand_budget as $gbudget) { }
                        ...
                        $grand_real = $this->db->query("SELECT sum(realisasi_jam) as greal from realisasi_lembur rl join pengajuan_lembur pl on pl.recid_plembur = rl.recid_plembur join master_budget mb on mb.recid_mbl = pl.recid_mbl join bagian b on mb.recid_bag = b.recid_bag where ($role) and mb.tahun =  '$tahun'")->result();
