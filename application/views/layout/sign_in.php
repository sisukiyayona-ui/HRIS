...
<head>
  ...
  <body class="bg-light-gray" id="body">
        ...
        <div class="col-xl-5 col-lg-6 col-md-10">
          <div class="card">
            <div class="card-header bg-primary">
              <div class="app-brand" style="margin-left:20px">
                 <!--  <svg class="brand-icon" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" width="30" height="33"
                  ...
                  <span class="brand-name">Cint Covid19 Tracking</span>
              </div>
            </div>
              ...
              <form method="post" action="<?php echo base_url()?>Auth/login" >
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="text" class="form-control input-lg" id="uname" name="uname" placeholder="Username" autocomplete="off" autofocus="on">
                  </div>
                  <div class="form-group col-md-12 ">
                    <input type="password" class="form-control input-lg" id="password"  name="pass" placeholder="Password" autocomplete="off">
                  </div>
                  <div class="form-group col-md-12">
                      <p><?=$image;?></p><br>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2021 Copyright PT. Chitose-Internansional Tbk.
        </p>
      </div>
    </div>
</body>
