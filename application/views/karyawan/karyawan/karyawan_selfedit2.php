    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <!-- Content Form -->
            <form enctype="multipart/form-data" method="post" id="testForm"  action="<?php echo base_url()?>Karyawan/karyawan_pselfedit2" class="form-horizontal form-label-left" id="demo-form" novalidate data-parsley-validate>
             ...
             <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <?php if($data->jenkel == "Laki - laki") {?>
                  <input type="radio" class="flat" name="jenkel" id="genderM" value="Laki - laki" checked="checked"  /> Laki - Laki 
                  <input type="radio" class="flat" name="jenkel" id="genderF" value="Perempuan" /> Perempuan 
                <?php  } else if($data->jenkel == "Perempuan"){?>
                  <input type="radio" class="flat" name="jenkel" id="genderM" value="Laki - laki"  />  Laki - Laki 
                  <input type="radio" class="flat" name="jenkel" id="genderF" value="Perempuan" checked="checked" /> Perempuan 
                <?php }else{?>
                  <input type="radio" class="flat" name="jenkel" id="genderM" value="Laki - laki"  />  Laki - Laki 
                  <input type="radio" class="flat" name="jenkel" id="genderF" value="Perempuan" /> Perempuan 
                <?php } ?>
                ...
                <div class="thumbnail">
                  ...
                  <div class="caption"> 
                    ...
                    if($data->scan_ktp == ''){
                      ...
                      <center><p><a href="<?php echo base_url()?>images/ktp/<?php echo $data->scan_ktp?>" target="__blank"><?php echo $data->scan_ktp?></a></p></center>
                    <?php } ?>
                  </div>
                </div>
                ...
                <div class="thumbnail">
                  ...
                  <div class="caption"> 
                    ...
                    if($data->scan_kk == ''){
                      ...
                      <center><p><a href="<?php echo base_url()?>images/kk/<?php echo $data->scan_kk?>" target="__blank"><?php echo $data->scan_kk?></a></p></center>
                    <?php } ?>
                  </div>
                </div>
                <span>* Isi Bila Akan Diubah </span>
                ...
                <div class="thumbnail">
                  ...
                  <div class="caption"> 
                    ...
                    if($data->scan_npwp == ''){
                      ...
                      <center><p><a href="<?php echo base_url()?>images/npwp/<?php echo $data->scan_npwp?>" target="__blank"><?php echo $data->scan_npwp?></a></p></center>
                    <?php } ?>
                  </div>
                </div>
                <span>* Isi Bila Akan Diubah </span>
        ...
        <div class="item form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="no_bkes">Nomor BPJS Kesehatan <span class="required" style="color: red" style="color: red">*</span>
        </label>
        <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="thumbnail">
          ...
          <div class="caption"> 
            ...
            if($data->scan_aia == ''){
              ...
              <center><p><a href="<?php echo base_url()?>images/aia/<?php echo $data->scan_aia?>" target="__blank"><?php echo $data->scan_aia?></a></p></center>
            <?php } ?>
          </div>
        </div>
        <span>* Isi Bila Akan Diubah </span>
        ...
        <div class="thumbnail">
          ...
          <div class="caption"> 
            ...
            if($data->scan_askes == ''){
              ...
              <center><p><a href="<?php echo base_url()?>images/askes/<?php echo $data->scan_askes?>" target="__blank"><?php echo $data->scan_askes?></a></p></center>
            <?php } ?>
          </div>
        </div>
        <span>* Isi Bila Akan Diubah </span>
        ...
        <div class="thumbnail">
          ...
          <div class="caption"> 
            ...
            if($data->scan_sim1 == ''){
              ...
              <center><p><a href="<?php echo base_url()?>images/sim/<?php echo $data->scan_sim1?>" target="__blank"><?php echo $data->scan_sim1?></a></p></center>
            <?php } ?>
          </div>
        </div>
        <span>* Isi Bila Akan Diubah </span>
        ...
        <div class="thumbnail">
          ...
          <div class="caption"> 
            ...
            if($data->scan_sim2 == ''){
              ...
              <center><p><a href="<?php echo base_url()?>images/sim/<?php echo $data->scan_sim2?>" target="__blank"><?php echo $data->scan_sim2?></a></p></center>
            <?php } ?>
          </div>
        </div>
        <span>* Isi Bila Akan Diubah </span>
