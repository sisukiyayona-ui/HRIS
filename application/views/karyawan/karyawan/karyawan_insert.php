          ...
          <div class="x_content">
            <form enctype="multipart/form-data" method="post" action="<?php echo base_url() ?>Karyawan/karyawan_pinsert" class="form-horizontal form-label-left" id="demo-form" novalidate data-parsley-validate>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="radio" class="flat" name="jenkel" id="genderM" value="Laki - laki" checked="" /> Laki - laki
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="scan_ktp">Scan NPWP
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="thn_lulus" type="text" name="thn_lulus" class="form-control col-md-7 col-xs-12" placeholder="Tahun Lulus">
                </div>
              </div>
              <div class="item form-group">
                <label for="jurusan" class="control-label col-md-3 col-sm-3 col-xs-12">Ijazah</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="ijazah" type="file" name="ijazah" class="form-control col-md-7 col-xs-12" placeholder="Ijazah">
                </div>
              </div>
              <div class="item form-group">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="sim2" class="form-control col-md-7 col-xs-12" onkeypress="return hanyaAngka(event)" placeholder="SIM 2" type="text">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="email" class="form-control col-md-7 col-xs-12" placeholder="Email"></textarea>
                </div>
              </div>
              <div class="item form-group">
