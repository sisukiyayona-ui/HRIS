               ...
               <?php 
                ...
                echo "
                  <tr>
                    ...
                    <td><center>";?>
                    <a 
                    data-recid_struktur="<?php echo $data->recid_struktur ?>"
                    data-nama="<?php echo $data->nama_struktur ?>"
                    data-note="<?php echo $data->note ?>"
                    data-toggle="modal" data-target="#edit_struktur">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Data Struktur</h4>
      </div>
      <div class="modal-body">
        ...
        <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url()?>Karyawan/struktur_pinsert" novalidate>
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_str">Nama Pada Struktur <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="nik" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="nama_struktur" placeholder="Nama Pada Struktur" required="required" type="text">
            </div>
          </div>
          <div class="item form-group">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Edit Data Bagian</h4>
      </div>
      <div class="modal-body">
        <!-- Content Modal -->
        <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url()?>Karyawan/bagian_update" novalidate>
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_bag">Nama Struktur <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
