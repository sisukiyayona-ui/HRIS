    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>index.php/Training/training_pinsert2" id="karir" novalidate >
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <table class="table table-striped table-bordered">
                    ...
                    <?php
                      ...
                      { ?>
                         <tr><td>Nama </td><td>
                          <select name="crt_by" id="pengaju"  class="selectpicker form-control col-md-12 col-xs-12" data-live-search="true">
                       ...
                       <tr><td>Bagian </td><td><input type="text" class="form-control col-md-7 col-xs-12" id="bag" readonly="readonly"></td></tr>
                       <tr><td>Jabatan </td><td><input type="text" class="form-control col-md-7 col-xs-12" id="jabatan" readonly="readonly"></td></tr>
                       <tr><td>Department</td><td><input type="text" class="form-control col-md-7 col-xs-12" id="department" readonly="readonly"></td></tr>
                       <tr><td>Tanggal Pengajuan </td><td>
                        <div class='input-group date' id='myDatepicker2'>
                          <input type='text' class="form-control" id="tgl_aju" name="tgl_pengajuan" required="required" placeholder="Tanggal Pengajuan"/>
                     ...
                     <?php  }
                      ...
                      { ?>
                        <tr><td>Nama </td><td><?php echo $nama ?><input type="hidden" class="form-control col-md-7 col-xs-12" name="crt_by" value="<?php echo $recid_karyawan ?>"></td></tr>
                        <tr><td>Bagian </td><td><?php echo $bagian ?></td></tr>
                        <tr><td>Jabatan </td><td><?php echo $jabatan?></td></tr>
                        <tr><td>Department</td><td><?php echo $department ?></td></tr>
                        <tr><td>Tanggal Pengajuan </td><td><?php echo $newDate = date("d M Y");?><input type="hidden" class="form-control col-md-7 col-xs-12" name="tgl_pengajuan" value="<?php echo date("Y-m-d") ?>"></td></tr>
                     <?php }
                    ?>
              ...
              <p style="color: red"> Harap tidak menggunakan tanda baca "&" pada isian formulir dibawah ini!</p><br>
              <div class="item form-group">
           ...
           <!--  <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="metoda" required="required" class="form-control col-md-7 col-xs-12" placeholder="Metoda">
                </div>
              </div> -->
            ...
            <div class="item form-group">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="lembaga" required="required" class="form-control col-md-7 col-xs-12" placeholder="Lembaga / Penyelenggara">
                </div>
              </div>
              <div class="item form-group">
       ...
       <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" name="jml_jam" required="required" class="form-control col-md-7 col-xs-12" onkeypress="return hanyaAngka(event)" placeholder="Jumlah Jam">
        </div>
      </div>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" name="biaya" required="required" class="form-control col-md-7 col-xs-12" onkeypress="return hanyaAngka(event)" placeholder="Biaya Sesuai Invoice" value="0">
        </div>
      </div>
...
<div class="item form-group">
  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="scan_bpjs">Scan Brosur
  </label>
  <div class="col-md-6 col-sm-6 col-xs-12">
...
<script type="text/javascript">
  ...
  $("#pengaju").change(function(){
    var crt_by = document.getElementById('pengaju').value;
    $.ajax({
            type: "POST", // Method pengiriman data bisa dengan GET atau POST
            url: "<?php echo base_url();?>Karyawan/karyawan_by_id", // Isi dengan url/path file php yang dituju
            data: {crt_by : crt_by}, // data yang akan dikirim ke file yang dituju
            dataType: "json",
            beforeSend: function(e) {
              if(e && e.overrideMimeType) {
                e.overrideMimeType("application/json;charset=UTF-8");
            ...
            success: function(response, data){ // Ketika proses pengiriman berhasil
              document.getElementById("bag").value = response[0]['indeks_hr'];
              document.getElementById("jabatan").value = response[0]['indeks_jabatan'];
              document.getElementById("department").value = response[0]['nama_department'];
            },
            error: function (xhr, ajaxOptions, thrownError) { // Ketika ada error
              alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError); // Munculkan alert error
            }
