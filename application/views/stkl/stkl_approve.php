            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <!-- Content Table -->
                    <form method="post" action="<?php echo base_url()?>Lembur/bulk_approve">
              ...
              <br>
                <button type="submit" name="btn_acc" class="btn btn-primary" value="approve">Approve</button>
                <!-- <button type="submit" name="btn_tolak" class="btn btn-danger" value="tolak">Tolak</button> -->
              </form>
              <!--/ Content Table -->
                  </div>
                </div>
    ...
    function getData()
     {
      ...
      var table = $('#t_stkl').DataTable( {
        ...
        "ajax": {
          type: "POST",
          url: "<?php echo base_url(); ?>Lembur/stkl_periode_app",
          dataType: 'JSON',
