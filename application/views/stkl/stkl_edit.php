              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    ?>
                     <form id="form_lembur" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Lembur/plembur_pupdate" data-toggle="validator">
                    ...
                    <div class="item form-group" id="lainnya" <?php if($s->recid_kategori != '11'){echo "style='display:none'";
                    } ?>>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="kat_lain" id="kat_lain" class="form-control" value="<?php echo $s->kat_lain ?>">
                        </div>
                      </div>
                    ...
                    <div class="item form-group">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            foreach ($anggota->result() as $key) {?>
                                ...
                                <td><center><a href="<?php echo base_url()?>index.php/Lembur/del_karyawan_lembur/<?php echo $key->recid_stkl ?>/<?php echo $key->recid_detstkl ?>/edit"><span class="fa fa-trash" style="color:red"></span></button></a></center></td>
                                </tr>
                            <?php  }
                            ?>
                      ...
                      <div class="item form-group">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            foreach ($pekerjaan->result() as $p) {?>
                                ...
                                <td><center><a href="<?php echo base_url()?>index.php/Lembur/del_pekerjaan/<?php echo $p->recid_plembur ?>/<?php echo $p->recid_detlembur ?>"><span class="fa fa-trash" style="color:red"></span></button></a>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                         ...
                         <a href="<?php echo base_url()?>Lembur/stkl_view"><button id="cancell" type="button" class="btn btn-danger">Cancel</button></a>
                       </div>
                     </div>
                     </form>
                  </div>
      ...
      <div class="modal-body">
        <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>index.php/Lembur/lembur_addkar" novalidate >
         ...
         <div class="item form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="hidden" name="dari" required="required" class="form-control col-md-7 col-xs-12" value="edit">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <textarea name="target" id="targets" class="form-control" onkeypress="return hanyaAngka(event)" placeholder="Target Lembur" rows="1" cols="1"></textarea>
        </div>
        </div>
        <div class="item form-group">
...
<div id="myModal4" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Edit Uraian Pekerjaan</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>index.php/Lembur/edit_target" novalidate >
         <div class="item form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="judul">Uraian Pekerjaan <span class="required" style="color: red">*</span>
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
