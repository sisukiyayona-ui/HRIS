            ...
            <table id="datatable-buttons" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                foreach ($gh->result() as $data) {?>
                  ...
                  <td><center>
                  <a 
                  data-gh_recid="<?php echo $data->gh_recid ?>"
                  ...
                  <a href="<?php echo base_url()?>Absen/gh_delete/<?php echo $data->gh_recid?>"><button class='btn btn-danger btn-xs'><span class='fa fa-trash'></span></button></a></td>
                  <?php  } ?>
                  </tr>
                <?php  } ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Hari Kerja Pengganti</h4>
      </div>
      <div class="modal-body">
        <!-- Content Modal -->
        <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url()?>Absen/gh_insert" novalidate>
        <div class="item form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Tanggal <span class="required">*</span>
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class='input-group date' id='myDatepicker2'>
              <input type='text' class="form-control" name="tanggal" id="tanggal1" placeholder="tanggal"  />
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Edit Hari Kerja Pengganti</h4>
      </div>
      <div class="modal-body">
        <!-- Content Modal -->
        <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url()?>Absen/gh_update" novalidate>
        <div class="item form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Tanggal <span class="required">*</span>
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="gh_recid" class="form-control col-md-7 col-xs-12"  type="hidden" name="gh_recid">
...
<script>
    $(document).ready(function() {
          ...
          $('#edit_user').on('show.bs.modal', function (event) {
              ...
              modal.find('#gh_recid').attr("value",div.data('gh_recid'));
  ...
  $("#tanggal1").change(function(){
   var tanggal = document.getElementById("tanggal1").value;
     $.ajax({  //---------------------------------------- cek total lembur --------------------------------------------------------
          type: "POST", // 
          url: "<?php echo base_url();?>Absen/cek_gh", 
          ...
          success: function(response, data){ // Ketika proses pengiriman berhasil
            if(response == '1'){
              alert("Tanggal sudah digunakan, mohon periksa kembali");
