                        ...
                        <ul class="nav navbar-nav navbar-right" style="height:56px;">
                            <li class="">
                                <div class="nav" style="margin:20px;">
                                    <a href="<?php echo base_url() ?>AbsenBarcode/absen_masuk" style="color:#FFF"><button type='button' class="btn btn-sm btn-primary">Absen Masuk</buttton></a>
                                    <a href="<?php echo base_url() ?>AbsenBarcode/absen_pulang" style="color:#FFF"><button type='button' class="btn btn-sm btn-warning">Absen Pulang</buttton></a>
                                </div>
                ...
                <div class="row" style="margin-top:25px;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div style="position:relative; width:100%; height:0px; padding-bottom:85%;">
                            <iframe id="monitor" style="position:absolute; left:0; top:0; width:100%; height:100%" src="<?php echo base_url() ?>AbsenBarcode/monitor_izin">
                            </iframe>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            function simpan_izin() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>AbsenBarcode/simpan_izin", // Isi dengan url/path file php yang dituju
                    async: false,
                    data: {
                        nik: nik,
                        jenis: jenis,
