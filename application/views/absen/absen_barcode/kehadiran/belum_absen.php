                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                            <td>
                                                <center><select class="form-control" id="jenis<?php echo $data->recid_karyawan ?>" onchange="updateData(<?php echo $data->recid_karyawan ?>)">
                                                        <option> -- Pilih --</option>
                                                        <?php
...
<script type="application/javascript">
    ...
    function getData() {
        ...
        var table = $('#t_hadir').DataTable({
            ...
            "ajax": {
                type: "POST",
                url: "<?php echo base_url(); ?>AbsenBarcode/get_tidak_hadir_periode",
                dataType: 'JSON',
                data: {
                    tgl_mulai: tgl_mulai
                },
