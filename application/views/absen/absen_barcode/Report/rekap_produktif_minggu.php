    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Report Produktivitas Jam Kerja Karyawan</h3>
            </div>
        </div>
          ...
          where recid_karyawan = '$usr' order by indeks_hr asc");
                                        ...
                                        foreach ($bagian->result() as $b) {
                                            ...
                                            if ($karyawan->num_rows() == 0) {
                                                ...
                                                foreach ($karyawan->result() as $k) {
                                                    $hitung_hk = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where b.recid_bag = $b->recid_bag and k.recid_karyawan = $k->recid_karyawan and (tanggal between '$mulai' and '$sampai') and is_closed = '0' and (status != 24 and status != '28' and status != '31' and status != '32' and status != '33' and status != '36');");
                                                    ...
                                                    $m = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai')  and h.status = '11' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $p1 = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '5' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $sid = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '2' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $kk = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '25' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $h1 = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '6' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $h2 = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '7' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $p4 = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '12' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $c = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '3' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $mu = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '34' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");

                                                    $gh = $db2->query("SELECT * FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and h.status = '35' and k.recid_karyawan = $k->recid_karyawan and h.is_closed = '0'");
                                                    ...
                                                    $total_absen = $m->num_rows() + $m->num_rows() + $sid->num_rows() + $kk->num_rows() + $h1->num_rows() + $h2->num_rows() + $mu->num_rows() + $gh->num_rows();

                                                    $jam_nonprd = number_format(($total_absen * 8), 2, '.', ''); // per jenis absensi

                                                    $fnorma = $db2->query("SELECT count(h.recid_absen) as jml_norma FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and $norma and k.recid_karyawan = $k->recid_karyawan and h.is_closed='0'");

                                                    foreach ($fnorma->result() as $fnorma) {
                                                        $jml_norma = $fnorma->jml_norma;
                                                    }

                                                    $fnnorma = $db2->query("SELECT count(h.recid_absen) as jml_nonnorma FROM hadir_barcode h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (tanggal between '$mulai' and '$sampai') and $non_norma and k.recid_karyawan = $k->recid_karyawan and h.is_closed='0'");
                                                    ...
                                                    if ($telat->num_rows() > 0) {
                                                        foreach ($telat->result() as $t) {
                                                            if ($t->over_durasi != "" or $t->over_durasi != null) {
                                                                $durasi_telat = number_format(($durasi_telat + $t->over_durasi), 2, '.', '');
                                                    ...
                                                    $durasi_izin = number_format(($durasi_telat + $durasi_izin), 2, '.', '');
                                                    ...
                                                    foreach ($pulang->result() as $p) {
                                                        if ($p->over_durasi != "" or $p->over_durasi != null) {
                                                            $durasi_pulang = number_format(($durasi_pulang + $p->over_durasi), 2, '.', '');
                                                    ...
                                                    $durasi_izin = number_format(($durasi_pulang + $durasi_izin), 2, '.', '');
                                                    ...
                                                    $durasi_izin = number_format(($durasi_kel + $durasi_izin), 2, '.', '');
                                                    if ($durasi_izin != 0) {
                                                        $durasi = $durasi_izin;
                                                        $dur = explode(".", $durasi);
                                                        if ($dur[1] > 60) {
                                                        ...
                                                        $menit = number_format(($dur[1] / 60), 2, '.', '');
                                                        $durasi_izin_pers = number_format(($dur[0] + $menit), 2, '.', '');
                                                    } else {
                                                        $durasi_izin_pers = 0;
                                                    }
                                                    ...
                                                    $jam_prod = ((($default_hk * 8) - $jam_nonprd));
                                                    // echo "Jam Produktif (x): " . ($jam_prod / ($default_hk * 8)) * 100 . "<br><br>";
                                                    if ($jam_nonprd != 0) {
                                                        $jam_prod_pers = ($jam_prod / ($default_hk * 8)) * 100;
                                                        // echo $jam_prod_pers;
                                                    } else {
                                                        $jam_prod_pers = ((($default_hk * 8)) / ($default_hk * 8)) * 100;
                                                    }
                                                    $jam_prod_pers = number_format($jam_prod_pers, 2, '.', '');
                                                    ...
                                                    $sdur_izin = number_format(($sdur_izin + $durasi_izin), 2, '.', '');
                                                    $sjam_prod = $sjam_prod + $jam_prod;
                                                    if ($sdur_izin != 0) {
                                                        $durasi = $sdur_izin;
                                                        $dur = explode(".", $durasi);
                                                        if ($dur[1] > 60) {
                                                        ...
                                                        $menit = number_format(($dur[1] / 60), 2, '.', '');
                                                        $sdur_izin_pers = number_format(($dur[0] + $menit), 2, '.', '');
                                                    } else {
                                                        $sdur_izin_pers = 0;
                                                    }
                                ...
                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $jam_prod ?> Jam </td>
                                                        <td><?php echo round(($jam_prod / $default_hk), 1) ?></td>
                                                        <td><?php echo $jam_prod_pers ?> % </td>
                                                        ...
                                                        <td><?php if ($durasi_izin != 0) {
                                                                ...
                                                                echo $dur[0] . " jam " . $dur[1] . " menit";
                                                            } ?></td> <!-- total durasi izin -->
                                                        <td><?php echo round((($durasi_izin_pers / ($default_hk * 8)) * 100), 2) ?> %</td> <!--  % total durasi izin --> <!--  % total durasi izin -->
                                                    </tr>
                                                <?php } ?>
                                            ...
                                            if ($kar_bagian != 0) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $sjam_prod ?></td>
                                                    <td><?php echo round(($sjam_prod / $s_hk), 1) ?></td>
                                                    ...
                                                    <td><?php echo round((($sdur_izin_pers / ($s_hk * 8)) * 100), 2) ?> %</td> <!--  % total durasi izin -->
                                                </tr>
                                                <tr>
                                            ...
                                            $ddur_izin = number_format(($ddur_izin + $sdur_izin), 2, '.', '');
                                            $djam_prod = $djam_prod + $sjam_prod;
                                            if ($ddur_izin != 0) {
                                                $durasi = $ddur_izin;
                                                $dur = explode(".", $durasi);
                                                if ($dur[1] > 60) {
                                                ...
                                                $menit = number_format(($dur[1] / 60), 2, '.', '');
                                                $ddur_izin_pers = number_format(($dur[0] + $menit), 2, '.', '');
                                            } else {
                                                $ddur_izin_pers = 0;
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $djam_prod ?></td>
                                            <td><?php echo round(($djam_prod / $d_hk), 1) ?></td>
                                            ...
                                            <td><?php echo round((($ddur_izin_pers / ($d_hk * 8)) * 100), 2) ?> %</td><!-- durasi_keluar % --> <!--  % total durasi izin -->
                                        </tr>
                                        <tr>
                                        ...
                                        /* if($dg_lbh > 0)
                          {
                            ...
                            $dg_hk2 = $dg_hk2 + $d_hk2;
                                        ...
                                        $dgdur_izin = number_format(($dgdur_izin + $ddur_izin), 2, '.', '');
                                        $dgjam_prod = $dgjam_prod + $djam_prod;
                                        if ($dgdur_izin != 0) {
                                            $durasi = $dgdur_izin;
                                            $dur = explode(".", $durasi);
                                            if ($dur[1] > 60) {
                                            ...
                                            $menit = number_format(($dur[1] / 60), 2, '.', '');
                                            $dgdur_izin_pers = number_format(($dur[0] + $menit), 2, '.', '');
                                        } else {
                                            $dgdur_izin_pers = 0;
                                        }
                                        /*------------ department calculation end ----------------*/ ?>
                                        ...
                                        $cdur_izin = number_format(($cdur_izin + $dgdur_izin), 2, '.', '');
                                        $cjam_prod = $cjam_prod + $djam_prod;
                                        if ($cdur_izin != 0) {
                                            $durasi = $cdur_izin;
                                            $dur = explode(".", $durasi);
                                            if ($dur[1] > 60) {
                                            ...
                                            $menit = number_format(($dur[1] / 60), 2, '.', '');
                                            $cdur_izin_pers = number_format(($dur[0] + $menit), 2, '.', '');
                                        } else {
                                            $cdur_izin_pers = 0;
                                        }
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $dgjam_prod ?></td>
                                        <td><?php echo round(($dgjam_prod / $dg_hk), 1) ?></td>
                                        ...
                                        <td><?php echo round((($dgdur_izin_pers / ($dg_hk * 8)) * 100), 2) ?> %</td><!-- durasi_keluar % --> <!--  % total durasi izin -->
                                    </tr>
                                    <tr>
                                        <td style="display:none"></td>
                                        <td style="display:none"></td>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $cjam_prod ?></td>
                                    <td><?php echo round(($cjam_prod / $c_hk), 1) ?></td>
                                    ...
                                    <td><?php echo round((($cdur_izin_pers / ($c_hk * 8)) * 100), 2) ?> %</td><!-- durasi_keluar % -->
                                </tr>
                                <tr>
    ...
    $(document).ready(function() {
        ...
        var table = $('#rekap_absen').DataTable({
            ...
            buttons: [{
                ...
                title: 'Rekap Produktivitas Periode' + mulai + ' s/d ' + sampai,
            }]
        });
    });
</script>