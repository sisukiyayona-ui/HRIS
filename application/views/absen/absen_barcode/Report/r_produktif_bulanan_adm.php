    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Report Persentase Kehadiran Bulanan</h2>

                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url() ?>AbsenBarcode/produktivitas_bulanan" class="form-horizontal form-label-left" id="demo-form" novalidate data-parsley-validate>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-1 col-sm-1 col-xs-1"><label>Bulan</label></div>
                                ...
                                <div class="col-md-1 col-sm-1 col-xs-1"><label>Tahun</label></div>
                                <div class="col-md-2 col-sm-2 col-xs-2">
    ...
    $(document).ready(function() {
        ...
        $("#divisi").change(function() { // Ketika user mengganti atau memilih data provinsi
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>Karyawan/dept_by_divisi_my", // Isi dengan url/path file php yang dituju
