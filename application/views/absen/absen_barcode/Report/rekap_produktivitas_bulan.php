                                        ...
                                        foreach ($bagian->result() as $b) {
                                            ...
                                            if ($karyawan->num_rows() == 0) {
                                                ...
                                                foreach ($karyawan->result() as $k) {
                                                    ...
                                                    // $total_absen = $m->num_rows() + $p1->num_rows() + $sid->num_rows() + $kk->num_rows() + $h1->num_rows() + $h2->num_rows() + $p4->num_rows() + $c->num_rows() + $mu->num_rows() + $gh->num_rows();

                                                    $total_absen = $m->num_rows() + $p1->num_rows() + $sid->num_rows() + $kk->num_rows() + $h1->num_rows() + $h2->num_rows() + $mu->num_rows() + $gh->num_rows();
