      ...
      <div class="">
        ...
        <div class="row">
          ...
          where recid_karyawan = '$usr' order by indeks_hr asc");
                        ...
                        foreach ($bagian->result() as $b) {
                          ...
                          if ($karyawan->num_rows() == 0) {
                            ...
                            foreach ($karyawan->result() as $k) {
                              ...
                              $jam_prod_persen = number_format((($jam_prod / ($default_hk * 8)) * 100), 2, '.', '');
                              ...
                              $sjam_prod = ($s_hk  * 8) - $snon_prod;
                              $sjam_prod_persen = number_format((($sjam_prod / ($s_hk * 8)) * 100), 2, '.', '');

                              /*------------ bagian calculation end ----------------*/
                    ?>
                              <tr>
                                <td rowspan='2'><?php echo $no++ ?></td>
                                <td rowspan='2'><?php echo $k->nik ?></td>
                                <td rowspan='2'><?php echo $k->nama_karyawan ?></td>
                                <td rowspan='2'><?php echo $k->indeks_hr ?></td>
                                <td rowspan='2'><?php echo $k->indeks_jabatan ?></td>
                                ...
                                <td><?php echo $jam_prod_persen ?></td>
                              ...
                              <tr>
                                ...
                                <td style="display:none"></td>
                                <td style="display:none"></td>
                                <td><?php echo $default_hk * 8 ?></td>
                                <td></td>
                                <td><?php echo $efektif * 8 ?></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                ...
                                <td><?php echo $m->num_rows() * 8 ?></td>
                                <td><?php echo $p1->num_rows() * 8 ?></td>
                                <td><?php echo $sid->num_rows() * 8 ?></td>
                                <td><?php echo $kk->num_rows() * 8 ?></td>
                                <td><?php echo $h1->num_rows() * 8 ?></td>
                                <td><?php echo $h2->num_rows() * 8 ?></td>
                                <td><?php echo $p4->num_rows() * 8 ?></td>
                                <td><?php echo $c->num_rows() * 8 ?></td>
                                <td><?php echo $mu->num_rows() * 8 ?></td>
                                <td></td>
                          ...
                          if ($kar_bagian != 0) { ?>
                            <tr>
                              <td colspan="4" rowspan="4">Total Bagian <?php echo $k->indeks_hr ?> </td>
                              <td style="display:none"></td>
                              <td style="display:none"></td>
                              <td style="display:none"></td>
                              ...
                              <td><?php echo $sjam_prod_persen ?>%</td>
                              <td><?php echo $s_m ?></td>
                              <td><?php echo $s_p1 ?></td>
                            ...
                            <tr>
                              ...
                              <td><?php echo $s_m * 8 ?></td>
                              <td><?php echo $s_p1 * 8 ?></td>
                              <td><?php echo $s_sid * 8 ?></td>
                              <td><?php echo $s_kk * 8 ?></td>
                              <td><?php echo $s_h1 * 8 ?></td>
                              <td><?php echo $s_h2 * 8 ?></td>
                              <td><?php echo $s_p4 * 8 ?></td>
                              <td><?php echo $s_c * 8 ?></td>
                              <td><?php echo $s_mu * 8 ?></td>
                              <td></td>
                            ...
                            <!-- end produktifitas jam -->
                            <!-- produktifitas bagian -->
                            <tr>
                              <!-- <td colspan="4">Total Bagian<?php echo $b->indeks_hr ?></td> -->
                              <td style="display:none"></td>
                              <td style="display:none"></td>
                        ...
                        <!--  end forach bagian -->
                        <tr>
                          <td colspan="4" rowspan="4">Total Department <?php echo $dp->nama_department ?> </td>
                          <td style="display:none"></td>
                          <td style="display:none"></td>
                          <td style="display:none"></td>
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td></td>
                          <td><?php echo $d_m * 8 ?></td>
                          <td><?php echo $d_p1 * 8 ?></td>
                          <td><?php echo $d_sid * 8 ?></td>
                          <td><?php echo $d_kk * 8 ?></td>
                          <td><?php echo $d_h1 * 8 ?></td>
                          <td><?php echo $d_h2 * 8 ?></td>
                          <td><?php echo $d_p4 * 8 ?></td>
                          <td><?php echo $d_c * 8 ?></td>
                          <td><?php echo $d_mu * 8 ?></td>
                          <td></td>
                        ...
                        <tr>
                          ...
                          <td><?php echo round((($ddur_pulang / ($d_hk * 8)) * 100), 2) ?> %</td>
                          <td><?php echo round((($ddur_kel / ($d_hk * 8)) * 100), 2) ?> %</td>
                          <td></td>
                          <td></td>
                          <td></td>
                          <!-- <td><?php echo $d_hk2 ?></td> -->
                      ...
                      <tr>
                        <td colspan="4" rowspan="4">Total Department Group <?php echo $fdivisi[$dg] ?> </td>
                        <td style="display:none"></td>
                        <td style="display:none"></td>
                        <td style="display:none"></td>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><?php echo $dg_m * 8 ?></td>
                        <td><?php echo $dg_p1 ?></td>
                        <td><?php echo $dg_sid * 8 ?></td>
                        <td><?php echo $dg_kk * 8 ?></td>
                        <td><?php echo $dg_h1 * 8 ?></td>
                        <td><?php echo $dg_h2 * 8 ?></td>
                        <td><?php echo $dg_p4 * 8 ?></td>
                        <td><?php echo $dg_c * 8 ?></td>
                        <td><?php echo $dg_mu * 8 ?></td>
                        <td></td>
                      ...
                      <tr>
                        ...
                        <td><?php echo round((($dgdur_pulang / ($dg_hk * 8)) * 100), 2) ?> %</td>
                        <td><?php echo round((($dgdur_kel / ($dg_hk * 8)) * 100), 2) ?> %</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <!-- <td><?php echo $d_hk2 ?></td> -->
                    ...
                    ?>
                    <tr>
                      <td colspan="4" rowspan="4">Total PT. Chitose </td>
                      <td style="display:none"></td>
                      <td style="display:none"></td>
                      <td style="display:none"></td>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td></td>
                      <td><?php echo $c_m * 8 ?></td>
                      <td><?php echo $c_p1 * 8 ?></td>
                      <td><?php echo $c_sid * 8 ?></td>
                      <td><?php echo $c_kk * 8 ?></td>
                      <td><?php echo $c_h1 * 8 ?></td>
                      <td><?php echo $c_h2 * 8 ?></td>
                      <td><?php echo $c_p4 * 8 ?></td>
                      <td><?php echo $c_c * 8 ?></td>
                      <td><?php echo $c_mu * 8 ?></td>
                      <td></td>
                    ...
                    <tr>
                      ...
                      <td><?php echo round((($cdur_kel / ($c_hk * 8)) * 100), 2) ?> %</td>
                      <td></td>
                      <td></td>
                      <td></td>
                      <!-- <td><?php echo $d_hk2 ?></td> -->
