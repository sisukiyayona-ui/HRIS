                ...
                <div class="row">
                            ...
                            <div class="x_title">
                               <div class="row">
                                    <div class="col-md-6 box1" style="float:left">
                                        <a href="<?php echo base_url() ?>AbsenBarcode/absen_masuk_baros"><button type="button" class="btn btn-danger btn-lg">Absen Masuk</button></a>
                                    </div>
                                    <div class="col-md-6 box2" style="float:right">
                                        <a href="<?php echo base_url() ?>AbsenBarcode/absen_pulang_baros"><button type="button" class="btn btn-warning btn-lg" style="float:right">Absen Pulang</button></a>
                                    </div>
                                </div>
                                <center>
                                    <br>
                                 <span style="font-size: 23pt; color:white">Absen </span> <span style="font-size: 23pt; color:red"><u>Pulang</u></span> <span style="font-size: 23pt; color:white">Baros</span>
                                </center>
                                <div class="clearfix">
                                </div>
                            </div>
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8">
                        <div style="position:relative; width:100%; height:0px; padding-bottom:48%;">
                            <iframe id="monitor" style="position:absolute; left:0; top:0; width:100%; height:100%" src="<?php echo base_url() ?>AbsenBarcode/monitor_pulang_baros">
                            </iframe>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            function simpan_pulang() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>AbsenBarcode/simpan_pulang_baros", // Isi dengan url/path file php yang dituju
                    async: false,
                    data: {
                        nik: nik
