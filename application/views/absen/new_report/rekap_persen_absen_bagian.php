                              ...
                              <tbody>
                                  ...
                                  where recid_karyawan = '$usr' order by indeks_hr asc");
                                            ...
                                            foreach ($bagian->result() as $b) {
                                                $hitung_hk = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where b.recid_bag = $b->recid_bag and (tanggal between '$mulai' and '$sampai') and status != 24 and k.tc = '0' and k.cci = 'Tidak';");
                                                ...
                                                $m = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai')  and h.status = '11' and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                $p1 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and h.status = '5' and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                $sid = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and h.status = '2' and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                $kk = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and h.status = '25' and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                $h1 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and h.status = '6' and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                $h2 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and h.status = '7' and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                $p4 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and h.status = '12' and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                $c = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and h.status = '3' and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                $fnorma = $db2->query("SELECT count(h.recid_absen) as jml_norma FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and $norma and b.recid_bag = $b->recid_bag and k.cci = 'Tidak'");

                                                foreach ($fnorma->result() as $fnorma) {
                                                    $jml_norma = $fnorma->jml_norma;
                                                }

                                                $fnnorma = $db2->query("SELECT count(h.recid_absen) as jml_nonnorma FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and $non_norma and b.recid_bag = $b->recid_bag");

                                                foreach ($fnnorma->result() as $fnnorma) {
                                                    $jml_nonnorma = $fnnorma->jml_nonnorma;
                                                }

                                                $telat = $db2->query("SELECT * from izin i join hris.karyawan k on k.recid_karyawan = i.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where(tgl_izin between '$mulai' and '$sampai') and jenis = 'Terlambat' and b.recid_bag = $b->recid_bag and is_delete = '0'");

                                                $pulang = $db2->query("SELECT * from izin i join hris.karyawan k on k.recid_karyawan = i.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where(tgl_izin between '$mulai' and '$sampai') and jenis = 'Pulang' and b.recid_bag = $b->recid_bag and is_delete = '0'");
                                                ...
                                                $ringan = $db2->query("SELECT * from absensi_hris a join hris.karyawan k on k.recid_karyawan = a.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and jenis_absen = 2 and kategori = 'Ringan' and b.recid_bag = $b->recid_bag");

                                                $lanjut = $db2->query("SELECT * from absensi_hris a join hris.karyawan k on k.recid_karyawan = a.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and jenis_absen = 2 and kategori = 'Berkelanjutan' and b.recid_bag = $b->recid_bag");

                                                $berat = $db2->query("SELECT * from absensi_hris a join hris.karyawan k on k.recid_karyawan = a.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (tanggal between '$mulai' and '$sampai') and jenis_absen = 2 and kategori = 'Berat' and  b.recid_bag = $b->recid_bag");
                                                ...
                                                $b_efektif_p = ($b_efektif / $b_hk) * 100;
                                                $b_tdk_kerja = $b_tdk_kerja + $tdk_kerja;
                                                $b_tdk_kerja_p = ($b_tdk_kerja / $b_hk) * 100;
                                                $b_norma = $b_norma + $jml_norma;
                                                $b_nonnorma = $b_nonnorma + $jml_nonnorma;
                                                $b_norma_p = ($b_norma / $b_hk) * 100;
                                                $b_nonnorma_p = ($b_nonnorma / $b_hk) * 100;
                                                $b_target_tk = (($b_hk - $b_nonnorma) / $b_hk) * 100;
                                                $b_m = $b_m + $m->num_rows();
                                    ...
                                    ?>
                                              ...
                                              <tr>
                                                  ...
                                                  <td></td>
                                                  <td></td>
                                                  <td><?php echo round((($m->num_rows() / $jml_hk) * 100), 2) ?> %</td>
                                          ...
                                          <tr style="background-color:#bbf0c5; color:#000;">
                                              ...
                                              <td></td>
                                              <td></td>
                                              <td><?php echo round((($b_m / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_p1 / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_sid / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_kk / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_h1 / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_h2 / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_p4 / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_c / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_telat / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_pulang / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_keluar / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_ringan / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_lanjut / $b_hk) * 100), 2) ?> %</td>
                                              <td><?php echo round((($b_berat / $b_hk) * 100), 2) ?> %</td>
                                          </tr>
