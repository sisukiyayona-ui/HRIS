                                ...
                                if($karyawan->num_rows() == 0)
                                {
                                  ...
                                  foreach ($karyawan->result() as $k) { 
                                    ...
                                    if($mulai_t == $sampai_t)
                                    {
                                      if($k->recid_bag == '24')
                                      {
                                        $hitung_hk = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where b.recid_bag = 24 and k.recid_karyawan = $k->recid_karyawan and year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and status != 24;");
                                        $jml_hk = $hitung_hk->num_rows();
                                      }else{
                                        $jml_hk = $jml_hkn;
                                      }
                                      $m = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and h.status = '11' and k.recid_karyawan = $k->recid_karyawan");

                                      $p1 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and h.status = '5' and k.recid_karyawan = $k->recid_karyawan");

                                      $sid = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and h.status = '2' and k.recid_karyawan = $k->recid_karyawan");

                                      $kk = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and h.status = '25' and k.recid_karyawan = $k->recid_karyawan");

                                      $h1 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and h.status = '6' and k.recid_karyawan = $k->recid_karyawan");

                                      $h2 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and h.status = '7' and k.recid_karyawan = $k->recid_karyawan");

                                      $p4 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and h.status = '12' and k.recid_karyawan = $k->recid_karyawan");

                                      $c = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and h.status = '3' and k.recid_karyawan = $k->recid_karyawan");

                                      $fnorma = $db2->query("SELECT count(h.recid_absen) as jml_norma FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and $norma and k.recid_karyawan = $k->recid_karyawan");

                                      foreach ($fnorma->result() as $fnorma) {
                                        $jml_norma = $fnorma->jml_norma;
                                      } 

                                      $fnnorma = $db2->query("SELECT count(h.recid_absen) as jml_nonnorma FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where year(tanggal) = $mulai_t and (month(tanggal) between '$mulai_b' and '$sampai_b') and $non_norma and k.recid_karyawan = $k->recid_karyawan");

                                      foreach ($fnnorma->result() as $fnnorma) {
                                        $jml_nonnorma = $fnnorma->jml_nonnorma;
                                      } 

                                      $telat = $db2->query("SELECT * from izin where year(tgl_izin) = $mulai_t and (month(tgl_izin) between '$mulai_b' and '$sampai_b') and jenis = 'Terlambat' and recid_karyawan = $k->recid_karyawan and is_delete = '0'");

                                      $pulang = $db2->query("SELECT * from izin where year(tgl_izin) = $mulai_t and (month(tgl_izin) between '$mulai_b' and '$sampai_b') and jenis = 'Pulang' and recid_karyawan = $k->recid_karyawan and is_delete = '0'");

                                      $jml_keluar = 0;
                                      $keluar = $db2->query("SELECT *, timediff(jam_in, jam_out) as lama from izin where jenis = 'Keluar' and year(tgl_izin) = $mulai_t and (month(tgl_izin) between '$mulai_b' and '$sampai_b') and recid_karyawan = $k->recid_karyawan and is_delete = '0'");
                                      ...
                                      if($k->recid_bag == '24')
                                      {
                                        $hitung_hk = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan join hris.bagian b on b.recid_bag = k.recid_bag where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and status != 24;");
                                        $jml_hk = $hitung_hk->num_rows();
                                      }else{
                                        $jml_hk = $jml_hkn;
                                      }

                                      $m = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and h.status = '11' and k.recid_karyawan = $k->recid_karyawan");

                                      $p1 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan  where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and h.status = '5' and k.recid_karyawan = $k->recid_karyawan");

                                      $sid = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tahun) = $sampai_t and month(tanggal) between 1 and $sampai_b) and h.status = '2' and k.recid_karyawan = $k->recid_karyawan");

                                      $kk = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan wherewhere (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and h.status = '25' and k.recid_karyawan = $k->recid_karyawan");

                                      $h1 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and h.status = '6' and k.recid_karyawan = $k->recid_karyawan");

                                      $h2 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawanwhere (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and h.status = '7' and k.recid_karyawan = $k->recid_karyawan");

                                      $p4 = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and h.status = '12' and k.recid_karyawan = $k->recid_karyawan");

                                      $c = $db2->query("SELECT * FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and h.status = '3' and k.recid_karyawan = $k->recid_karyawan");

                                      $fnorma = $db2->query("SELECT count(h.recid_absen) as jml_norma FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and $norma and k.recid_karyawan = $k->recid_karyawan");

                                      foreach ($fnorma->result() as $fnorma) {
                                        $jml_norma = $fnorma->jml_norma;
                                      } 

                                      $fnnorma = $db2->query("SELECT count(h.recid_absen) as jml_nonnorma FROM hadir_hris h join hris.karyawan k on k.recid_karyawan = h.recid_karyawan  where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and $non_norma and k.recid_karyawan = $k->recid_karyawan");
                                      ...
                                      $pulang = $db2->query("SELECT * from izin where (year(tgl_izin) = $mulai_t and month(tgl_izin) between $mulai_b and 12) or (year(tgl_izin) = $sampai_t and month(tgl_izin) between 1 and $sampai_b)tgl_izin and jenis = 'Pulang' and recid_karyawan = $k->recid_karyawan");

                                      $keluar = $db2->query("SELECT *, timediff(jam_in, jam_out) as lama from izin where jenis = 'Keluar' and (year(tgl_izin) = $mulai_t and month(tgl_izin) between $mulai_b and 12) or (year(tgl_izin) = $sampai_t and month(tgl_izin) between 1 and $sampai_b)and recid_karyawan = $k->recid_karyawan or (jenis = 'keluar' and jam_out >= '11:30:00' and timediff(jam_in, jam_out) >= '01:01:00' and recid_karyawan = $k->recid_karyawan)");

                                      $ringan = $db2->query("SELECT * from absensi_hris where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and jenis_absen = 2 and kategori = 'Ringan' and recid_karyawan = $k->recid_karyawan");

                                      $lanjut =  $db2->query("SELECT * from absensi_hris where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and jenis_absen = 2 and kategori = 'Berkelanjutan' and recid_karyawan = $k->recid_karyawan");

                                      $berat =  $db2->query("SELECT * from absensi_hris where (year(tanggal) = $mulai_t and month(tanggal) between $mulai_b and 12) or (year(tanggal) = $sampai_t and month(tanggal) between 1 and $sampai_b) and jenis_absen = 2 and kategori = 'Berat' and recid_karyawan = $k->recid_karyawan"); 
                                    }
