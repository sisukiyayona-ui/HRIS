                                  ...
                                  <?php
                                    ...
                                    for ($dg = 0; $dg < count($fdivisi); $dg++)  /*--- loop dept group ---*/ {
                                        ...
                                        foreach ($dept->result() as $dp) { ?>
                                          ...
                                          JOIN hris.bagian b on b.recid_bag = a.recid_bag
                                          join hris.department d on d.recid_department = b.recid_department
                                          where d.dept_group = '$dept_group' order by indeks_hr asc");
                                            }else {
                                                      ...
                                                      <tr>
                                                          ...
                                                          <?php
                                                            ...
                                                            while ($mulai2 <= $sampai2) {
                                                                $cek_absen = $this->db->query("SELECT * FROM master_absen.hadir_hris h join master_absen.jenis_absen ja on h.status = ja.recid_jenisabsen join hris.karyawan k on k.recid_karyawan = h.recid_karyawan where k.recid_karyawan = $k->recid_karyawan and tanggal = '$mulai2'");
                                                               /*  $cek_makan = $this->db->query("SELECT * from makan where recid_karyawan = $k->recid_karyawan and tgl_makan = '$mulai2'");*/
                                                                ...
                                                                if ($cek_absen->num_rows() > 0) {
                                                                    ...
                                                                    if($absen_group == "Hadir" and $ca->recid_jenisabsen != 24)
                                                                    {
                                                                        $total_k = $total_k + 1;
