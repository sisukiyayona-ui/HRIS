          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="<?php echo base_url()?>index.php/Recruitment/recruitment_view"><i class="fa fa-arrow-circle-o-left"></i></a> | Data FPTK</h2>
                      ...
                      <tbody>
                       ...
                       foreach ($fptk as $data) {
                        ...
                        if($role == '1' or $role == '2' or $role == '5'){?>
                          <a href="<?php echo base_url()?>index.php/Recruitment/fptk_update/<?php echo $data->recid_fptk?>" data-toggle="tooltip" data-placement="top" title="Edit"><button class="btn btn-info btn-xs"><span class='fa fa-pencil'></span></button></a>
                          <a href="<?php echo base_url()?>index.php/Recruitment/kfptk_insert/<?php echo $data->recid_fptk?>" data-toggle="tooltip" data-placement="top" title="Kaji"><button class="btn btn-success btn-xs"><span class='fa fa-check'></span></button></a>
                        <?php } ?>
                      <?php } ?>
