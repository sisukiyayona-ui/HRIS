                ...
                <div class="x_panel">
                  <div class="x_title">
                   <?php if($role == '1' or $role == '7' or $role == '5' ){ ?>
                    <a class="btn btn-info btn-sm" href="<?php echo base_url()?>Karyawan/cutoff_insert">
                       ...
                       foreach ($cutlembur as $data) {
                        ...
                        <td><center>
                         <!--  <a href="<?php echo base_url()?>Karyawan/cutoff_detail/<?php echo $data->recid_clembur?>"><button class="btn btn-success btn-xs"><span class='fa fa-search-plus'></span></button></a> -->
                          <a href="<?php echo base_url()?>Karyawan/cutoff_update/<?php echo $data->recid_clembur?>"><button class="btn btn-info btn-xs"><span class='fa fa-edit'></span></button></a>
                        <?php } ?>
                      <?php } ?>
