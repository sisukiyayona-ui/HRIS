                  ...
                  <div class="x_content">
                      ...
                      <tbody>
                       ...
                       foreach ($training as $data) {
                        ...
                        <td><center>
                        <a href="<?php echo base_url()?>Karyawan/training_update/<?php echo $data->recid_training ?>"><button class="btn btn-info btn-xs"><span class='fa fa-edit'></span></button></a>
                       <a href="<?php echo base_url()?>Karyawan/training_detail/<?php echo $data->recid_training ?>"><button class="btn btn-success btn-xs"><span class='fa fa-search-plus'></span></button></a></center></td>
                        <?php  } ?>
                    </tbody>
                  </table>
          <!--/ Content Table -->
