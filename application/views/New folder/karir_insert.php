        ...
        <div class="x_panel">
          ...
          <div class="item form-group">
           ...
           <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <!-- <select name="nik[]" class="form-control col-md-7 col-xs-12 searchable" id='callbacks' multiple='multiple' required="required" onchange="cek_spm()">
             <?php
             foreach ($karyawan as $option) {
               echo "<option value='$option->recid_karyawan'>$option->nama_karyawan ($option->nik)</option>";
             }
...
<div class="item form-group">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <input type="radio"  name="sts_aktif" id="tidak_aktif" value="Aktif"  />  Aktif  &nbsp;
    <input type="radio"  name="sts_aktif" id="tidak_aktif" value="Tidak Aktif" />  Tidak Aktif 
  </div><br>
