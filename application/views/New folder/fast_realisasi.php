              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2><a href="<?php echo base_url()?>Karyawan/fast_view"><i class="fa fa-arrow-circle-o-left"></i></a> | Pengajuan - Realisasi</h2>
                     <?php } ?>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                     <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Karyawan/fast_pinsert" data-toggle="validator" >
...
$("#total_lembur").change(function(){
 ...
 jam_lembur = parseFloat(jam_lembur);
