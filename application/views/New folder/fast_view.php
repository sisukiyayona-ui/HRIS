              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a class="btn btn-info btn-sm" href="<?php echo base_url()?>Karyawan/fast_realisasi">
                   ...
                   <div class="table-responsive">
                    ...
                    <tbody>
                     ...
                     if($role == '1' or $role == '2' or $role == '5' or $role == '7'){ ?>
                      <a href="<?php echo base_url()?>Karyawan/fast_update/<?php echo $data->recid_lembur?>" data-toggle="tooltip" data-placement="top" title="Edit Realisasi"><button class="btn btn-info btn-xs"><span class='fa fa-pencil'></span></button></a>
                    <?php }
                    } ?>
