                  ...
                  <div class="x_content">
                   ...
                   <div class="table-responsive">
                    ...
                    <tbody>
                     ...
                     <!--  <a href="<?php echo base_url()?>Karyawan/realisasi_detail/<?php echo $data->recid_lembur?>" data-toggle="tooltip" data-placement="top" title="Detail"><button class="btn btn-success btn-xs"><span class='fa fa-search-plus'></span></button></a> -->
                    <?php }else
                    {?>
                     <!--  <a href="<?php echo base_url()?>Karyawan/realisasi_update/<?php echo $data->recid_lembur?>" data-toggle="tooltip" data-placement="top" title="Edit"><button class="btn btn-success btn-xs"><span class='fa fa-search-plus'></span></button></a> -->
                    <?php }
                    } ?>
