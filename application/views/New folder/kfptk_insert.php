          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="<?php echo base_url()?>Karyawan/recruitment_view"><i class="fa fa-arrow-circle-o-left"></i></a> | Kajian FPTK</h2>
                  ...
                  <?php foreach ($fptk as $fptk) {} ?>
                   <form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Karyawan/kfptk_pinsert" class="form-horizontal form-label-left" id="demo-form" novalidate data-parsley-validate>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <table class="table table-striped table-bordered">
                          <tr><td colspan="2"><b>Pemohon</b></td></tr>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <div class='input-group date' id='myDatepicker2'>
                  <input type='text' class="form-control" name="tgl_hc" required="required" placeholder="Tanggal Acc HC"/>
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
             <div class='input-group date' id='myDatepicker4'>
              <input type='text' class="form-control" name="tgl_bod" required="required" placeholder="Tanggal Acc BOD"/>
              <span class="input-group-addon">
               <span class="glyphicon glyphicon-calendar"></span>
             </span>
           </div>
            ...
            <div class="form-group">
              <div class="col-md-6 col-md-offset-3">
               <a href='<?php echo base_url()?>Karyawan/pelamar_view'><input type="button" class="btn btn-primary" value="Cancel"></button></a>
