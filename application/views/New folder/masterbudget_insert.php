            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Karyawan/masterbudget_pinsert" novalidate >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="recid_bag"  class="selectpicker form-control  col-md-12 col-xs-12" data-live-search="true" required="required">
                            <?php
        ...
        <script>
          ...
          $("#tahun").change(function(){
            ...
            $.ajax({  //---------------------------------------- GET RANGE --------------------------------------------------------
                  type: "POST", // 
                  url: "<?php echo base_url();?>Karyawan/get_cutoff", 
                  data: {tahun : tahun}, 
                  dataType: "json",
