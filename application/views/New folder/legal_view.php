          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Data Perizinan & Perjanjian Chitose</h3>
              </div>
            </div>
                  ...
                  <div class="x_content">
                      ...
                      <tbody>
                       ...
                       foreach ($legal as $data) {
                        ...
                        <td><center>
                        <a href="<?php echo base_url()?>Karyawan/legal_update/<?php echo $data->recid_legal ?>"><button class="btn btn-info btn-xs"><span class='fa fa-edit'></span></button></a></center></td>
                        <?php  } ?>
                    </tbody>
                  </table>
                </div>
