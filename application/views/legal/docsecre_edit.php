    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Edit Nomor Dokumen Eksternal Corsec</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <!-- Content Form -->
                        <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url() ?>Karyawan/docsecre_pupdate" novalidate>

                            <!-- <span class="section">Personal Info</span>-->
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note">Nomor Dokumen
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="nomor_doc" required="required" placeholder="Perihal" class="form-control col-md-7 col-xs-12" readonly value="<?php echo $nomor_doc ?>">
                                    <input type="hidden" name="recid_doc" required="required" placeholder="Recid Dokumen" class="form-control col-md-7 col-xs-12" readonly value="<?php echo $recid_doc ?>">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" id="recid_karyawan" type="hidden" value="<?php echo $recid_karyawan ?>">
                                    <input class="form-control col-md-7 col-xs-12" id="recid_role" name="recid_role" type="hidden" value="<?php echo $role; ?>">
                                    <select name="recid_karyawan" id="karyawan" class="selectpicker form-control col-md-12 col-xs-12" data-live-search="true" <?php if ($role == '1') { ?> onchange=get_dept(); <?php } ?> </select>
                                    </select>
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="tujuan" placeholder="Tujuan Dokumen Eksternal" required="required" type="text" value="<?php echo $tujuan ?>">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="deskripsi" required="required" placeholder="Perihal" class="form-control col-md-7 col-xs-12" value="<?php echo $deskripsi ?>">
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function load_karyawan() {
        ...
        recid_karyawan = document.getElementById('recid_karyawan').value;
        if (role == '1') {
            urls = "<?php echo base_url(); ?>Karyawan/emp_aktif_all_edit";
            recid_struktur = '';
        } else {
            recid_struktur = document.getElementById('recid_struktur').value;
            urls = "<?php echo base_url(); ?>Karyawan/emp_by_struktur_edit";
        }
        $.ajax({
