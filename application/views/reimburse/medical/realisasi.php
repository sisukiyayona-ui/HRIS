        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <h4 style="color: red;"><?php echo $this->session->flashdata('warning'); ?></h2>
              <form  enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Medical/proses_realisasi" class="form-horizontal form-label-left" id="demo-form" novalidate data-parsley-validate>
               <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="username">Tipe <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="tipe" id="tipe" class="form-control col-md-12 col-xs-12" required="required" onchange="jenis_optik()" disabled="">
              ...
              <div class="item form-group" id="optik" style="display: none">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12" >
                  <select name="jenis" id="jenis" class="selectpicker form-control col-md-12 col-xs-12" required="required" readonly="readonly">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div>
                    <select name="nik" id="nik" class="form-control col-md-12 col-xs-12" data-live-search="true" required="required" onchange="detail_karyawan()" disabled="">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select  id="nama_kuitansi"  class="form-control" name="nama_kuitansi" readonly="readonly">
                    <option></option>
                  </select>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class='input-group date ' id='myDatepicker3'>
                    <input type='text' class="form-control" name="tgl_kuitansi" value="<?php echo $data->tgl_kuitansi ?>" readonly="readonly"/>
             ...
             <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea name="diagnosa" id="diagnosa" class="form-control" readonly="readonly"><?php echo $data->diagnosa ?></textarea>
              </div> 
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id='nominal' name="nominal" class="form-control money" value="<?php echo $data->nominal ?>" readonly="readonly">
             </div>
           </div>
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Sisa Plafon <span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id='sisa' name="sisa" class="form-control money" value="<?php echo $sisa ?>" readonly="readonly">
             </div>
           </div>
           <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Nominal Realisasi <span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id='nilai_ganti' name="nilai_ganti" class="form-control money">
             </div>
           </div>
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <a target="__blank" href="<?php echo base_url()?><i class='fa fa-file-image-o'></i><?php echo $data->path_medical?><?php $data->file_medical?><?php echo $data->file_medical?>"><?php echo $data->file_medical ?></a>
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Status Pengajuan<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
             <input type="radio" name="status"  value="Realisasi" checked="checked"> Realisasi
             <input type="radio" name="status"  value="Ditolak"> Ditolak
           </div>
         </div>
         <div class="item form-group" id="alasan">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Note <span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <div class="item form-group">
            ...
            <input type="submit" class="btn btn-primary"  name="status" value="Save">
          </div>
          </div>
...
function nilai_ganti()
{
  medical_recid = document.getElementById('medical_recid').value;
  $.ajax({
    type : "POST",
              url : "<?php echo base_url();?>Medical/hitung_realisasi", // Isi dengan url/path file php yang dituju
              data: {medical_recid : medical_recid}, // data yang akan dikirim ke file yang dituju
              dataType: "json",
              beforeSend: function(e) {
                if(e && e.overrideMimeType) {
                  e.overrideMimeType("application/json;charset=UTF-8");
              ...
              success: function(data, response){
               document.getElementById("nilai_ganti").value = data;
             }
           });
}
