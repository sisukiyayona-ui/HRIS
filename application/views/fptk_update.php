          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="<?php echo base_url()?>Karyawan/recruitment_view"><i class="fa fa-arrow-circle-o-left"></i></a> | Update FPTK</h2>
                    
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                  <h4><span class="label label-success">Data Pemohon</span></h4>
                   <form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>Karyawan/fptk_pupdate" class="form-horizontal form-label-left" id="demo-form" novalidate data-parsley-validate>
           ...
           <div class="item form-group">
            ...
            <div class="form-group">
              <div class="col-md-6 col-md-offset-3">
               <a href='<?php echo base_url()?>Karyawan/fptk_view'><input type="button" class="btn btn-primary" value="Cancel"></button></a>
