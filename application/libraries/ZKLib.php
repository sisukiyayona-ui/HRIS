...
class ZKLib
{
     ...
     */
    public function __construct($ip = '192.168.9.201', $port = 4370)
    {
        // Check if sockets extension is loaded
        if (!extension_loaded('sockets')) {
            throw new Exception('PHP Sockets extension is not loaded. Please enable it in php.ini');
        }
